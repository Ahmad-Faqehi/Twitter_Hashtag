      ...
      <!-- End of Topbar -->
       ...
       <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-info Font-tajawal text-right">نموذج أضافة هاشتاق</h6>
                </div>
                <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="explain" class="form-control form-control-user" cols="30" rows="3"></textarea>
                    </div>
                    ...
                    <label for="code" class="pull-right">كود التغريدة</label>
                      <textarea name="code" class="form-control form-control-user" cols="30" rows="7"></textarea>
                    </div>

                    <div class="form-group">
                    <label for="code2" class="pull-right">كود التغريدة الاولى <small> (أتركه فارغ اذا لم يجد) </small></label>
                      <textarea name="code2" class="form-control form-control-user" cols="30" rows="7"></textarea>
                    </div>
                    

                    <input type="submit" name="create" value="أضافة" class="btn btn-info btn-block">
